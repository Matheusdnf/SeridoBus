...
type SituacaoEnum = 'associado' | 'cadastrado' | 'carona' | 'representante';
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="p-4 space-y-4">
        <Text className="text-lg font-bold text-black">Editar Usuários</Text>
        {/* Barra de Pesquisa */}
        <TextInput
          ...
          >
            ...
            >
              ...
              >
                ...
                <Picker.Item label="representante" value="representante" />
              </Picker>
            </View>
